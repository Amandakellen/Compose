    ...
    Column(Modifier.fillMaxWidth()) {
        Row(Modifier.weight(1f)) {
            ComposableInfoCard(
                ...
                description = stringResource(R.string.text_content),
                backgroundColor = Color(0xFFEADDFF),
                modifier = Modifier.weight(1f)
            )
            ComposableInfoCard(
                title = stringResource(R.string.image_title),
                description = stringResource(R.string.image_content),
        ...
        Row(Modifier.weight(1f)) {
            ComposableInfoCard(
                ...
                description = stringResource(R.string.row_content),
                backgroundColor = Color(0xFFB69DF8),
                modifier = Modifier.weight(1f)
            )
            ComposableInfoCard(
                title = stringResource(R.string.column_title),
                description = stringResource(R.string.column_content),
